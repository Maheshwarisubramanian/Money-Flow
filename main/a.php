...
if(isset($_REQUEST['btnSubmit']))
{
    ...
    //  $category = array('moneyflow[]');
        ...
        $moneyflow = $_REQUEST['moneyflow'];
        $narration =$_REQUEST['txtNarration'];
         // echo $category;
         // echo "<br>";
         ...
         <div class="user-details">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="width: 15%;">
                        <input style="width: 100%;" type="text" name="txtMoneyflow" id="txtMoneyflow" value="" onkeypress="return onlyNumberKey(event)" />
                    </td>
                    <td style="width: 45%;">
